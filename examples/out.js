...
var _elm_lang$navigation$Navigation$programWithFlags$ = F2(
	function (mkParser, stuff) {
		var location = _elm_lang$navigation$Native_Navigation.getLocation(
			{ctor: '_Tuple0'});
		var init = function (flags) {
			var _p18 = mkParser(flags);
			var parser = _p18._0;
			return A2(
				_elm_lang$navigation$Navigation$updateHelp,
				_elm_lang$navigation$Navigation$UserMsg,
				...
				return A2(
					...
					function () {
						...
						if (_p19.ctor === 'Change') {
							...
							return A2(stuff.update, _p19._0, model);
						}
					}());
			});
		return _elm_lang$html$Html_App$programWithFlags(
...
var _user$project$Main$fromUrl = F2(
	function (flags, url) {
		return _elm_lang$core$String$toInt(
			A2(
				_elm_lang$core$String$dropLeft,
				3 + _elm_lang$core$String$length(flags.prefix),
				url));
	});
var _user$project$Main$urlParser = function (flags) {
	return _elm_lang$navigation$Navigation$makeParser(
		function (_p0) {
			return A2(
				_user$project$Main$fromUrl,
				flags,
				function (_) {
					return _.hash;
				}(_p0));
...
var _user$project$Main$toUrl = function (model) {
	return A2(
	...
	function (msg, model) {
		...
		return {
			...
			_1: _elm_lang$navigation$Navigation$newUrl(
				_user$project$Main$toUrl(newModel))
		};
	});
		...
		if (_p2.ctor === 'Ok') {
			...
			return {
				...
				_1: _elm_lang$navigation$Navigation$modifyUrl(
					_user$project$Main$toUrl(model))
			};
		}
	});
...
var _user$project$Main$main = {
	...
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'prefix', _elm_lang$core$Json_Decode$string),
		function (prefix) {
